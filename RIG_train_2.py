...
from def_module import generate_valid_positions, generate_valid_initial_position, board_to_tensor, generate_legal_actions_mask, decoder_action
...
exploration_states = generate_valid_positions(vae_state_collection_size)          # Collect D using various positions (1.)
...
for episode in range(num_episodes):
    ...
    board = generate_valid_initial_position()          # Sample initial state (6.)
...
torch.save(policy.state_dict(), "policy_2.pth")
print("Apprentissage du VAE et de la politique terminé et enregistré dans", "vae_2.pth", " et", "policy_2.pth")